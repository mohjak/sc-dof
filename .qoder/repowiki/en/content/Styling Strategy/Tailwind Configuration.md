...
**Section sources**
- [tailwind.config.ts](tailwind.config.ts#L8-L14)
...
**Section sources**
- [tailwind.config.ts](tailwind.config.ts#L75-L79)
- [index.css](src/index.css#L59-L59)
...
**Diagram sources**
- [accordion.tsx](src/components/ui/accordion.tsx#L1-L53)
- [tailwind.config.ts](tailwind.config.ts#L80-L93)
- [postcss.config.js](postcss.config.js#L1-L7)
...
**Section sources**
- [tailwind.config.ts](tailwind.config.ts#L96-L96)
- [package.json](package.json#L61-L61)
...
**Section sources**
- [index.css](src/index.css#L24-L127)
- [tailwind.config.ts](tailwind.config.ts#L21-L73)
...
- [tailwind.config.ts](tailwind.config.ts#L54-L73)
